...
if polarity == 'flipped':
     dir = g4bl_dir+'flipped/' # All input files must be in this same directory
elif polarity == 'not_flipped':
     dir = g4bl_dir+'not-flipped/'

# Define file locations:
if polarity == 'flipped':
     file = dir+'flipsign.in'
elif polarity == 'not_flipped':
     file = dir+'threecoils.in'
file_for_g4bl = '"'+file+'"'
    ...
    with open(file, 'r') as f:
        ...
        for i, line in enumerate(lines):
            ...
            if 'param tilt=' in line:
                lines[i] = f"param tilt={parameters['tilt']} #deg\n"
